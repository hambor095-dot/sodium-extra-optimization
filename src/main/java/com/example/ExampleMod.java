...
public class ExampleMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            // Логика триггера (Только криты в прыжке)
            if (triggerActive && client.crosshairTarget != null && client.crosshairTarget.getType() == HitResult.Type.ENTITY) {
